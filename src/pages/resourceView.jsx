  ...
  return (
    <div> 
        ...
        <div className="flex flex-row mr-10">  
            ...
            {params.login2} Resources has {resourceData.length} entries,
            with total cost {sum.toFixed(2)}, and has total Consumed Quantity as{" "}
            {ConsumedQuantity.toFixed(2)}
          <div>Search Parameter Used : {textr == 0 ? entry : textr != 0 || entry !=0 ? entry : textr} </div>
          </div>
          ...
          <div className="mt-[15vh] mb-[10vh] w-[60%] border-solid border-2 border-blue-900 p-[3vh] flex justify-center items-center flex-col">
            <h1>Bar Chart Analysis - </h1>
             ...
             <p className="mb-[5vh]">Y - Axis ( Total Consumed Quantity of the Resource Groups belonging to this resource) </p>
             <p> This program currently answers Questions like which Resource Group consumes the most out of the Resources allocated to a specific resource ?</p>
             <p className="mb-[4vh] "> For Example - <u>{Resources_names_cq_max}</u>, Resource Group takes or consumes the <u>most</u> resources for <u>{params.login2} </u>Resource present with the company.</p>
             <NameChartR />
          </div>
          <div className="mt-[15vh] mb-[10vh] w-[60%] border-solid border-2 border-red-900 p-[3vh] flex justify-center items-center flex-col">
            <h1>Bar Chart Analysis - </h1>
             ...
             <p> This program currently answers Questions like which Resource Group ranked on top in terms of a specific Resource ?</p>
             <p className="mb-[4vh] "> For Example - <u>{Resources_explain_cost}</u>, groups costs the <u>most</u> for <u>{params.login2} Resource</u></p>
             <CostChartR />
          </div>
          </div>
